...
@section('buttons')
    <a href="/admin/page/add" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> page</a>
@endsection
    ...
    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive" cellspacing="0"
        ...
        @foreach ($pages as $key=>$page)
            <tr>
                ...
                <td class="text-center">
                    <button onclick="delete_item(this, {{$page->slug}});" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></button>
                </td>
                <td class="text-center">
                    <a href="/admin/page/edit/{{$page->slug}}" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i></a>
                </td>
            </tr>
        @endforeach
        </tbody>
