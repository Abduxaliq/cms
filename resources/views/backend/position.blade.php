...
@section('buttons')
    <a href="/admin/position/add" class="btn btn-success btn-sm"> <i class="fa fa-plus"></i> Position </a>
@endsection
    ...
    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
        ...
        @foreach ($positions as $key=>$position)
            <tr>
                ...
                <td class="text-center">
                    <button onclick="delete_item(this, '{{$position->slug}}');" class="btn btn-danger btn-xs">
                        <i class="fa fa-trash"></i>
                    </button>
                </td>
                <td class="text-center">
                    <a href="/admin/position/edit/{{$position->slug}}" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i></a>
                </td>
            </tr>
        @endforeach
        </tbody>
