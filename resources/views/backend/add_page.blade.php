...
@section('content')
    <form method="post" action="/admin/page/add" id="add-page-form"
          class="form-horizontal form-label-left" enctype="multipart/form-data">
        {{csrf_field()}}
        {{ Form::bsTextPosts('title', 'Title', '', ['required' => 'required']) }}
        <div class="form-group">
            <label class="control-label col-md-2 col-sm-2 col-xs-12">Content</label>
            <div class="col-md-10 col-sm-10 col-xs-12">
                <textarea name="content" cols="30" rows="10" class="ckeditor"></textarea>
            </div>
        </div>
        <div class="form-group">
